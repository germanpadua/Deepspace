...
public class SpaceStationView extends javax.swing.JPanel {
    ...
    void enabledButtons(SpaceStationToUI station){
        ...
        descartarHangar_button.setEnabled(hangarAvaiable && (init  || aftercombat));
        equipar_button.setEnabled(hangarAvaiable && elementsInHangar && (init  || aftercombat));
        descartar_button.setEnabled((elementsInHangar || weaponsMounted || shieldsMounted) && (init  || aftercombat));
